...
class GatewayDefaultsTest extends TestCase
{
    ...
    {
        // Inclusion by default: a new case must classify itself. methods() is a match with
        ...
        $intents = [
            ...
            Capability::SubscriptionMetadata, Capability::SubscriptionNoProration,
            Capability::Taxes, Capability::Discounts,
        ];
