...
use Isapp\CashierSupport\Models\Customer as BaseCustomer;

/**
 * The concrete Customer model Cashier::fake() binds for the fake driver.
 *
 * Models\Customer is abstract — deliberately, so each driver names its own — which
 ...
 */
class FakeCustomer extends BaseCustomer {}
