...
use Isapp\CashierSupport\Models\SubscriptionItem as BaseSubscriptionItem;

/**
 * The concrete SubscriptionItem model Cashier::fake() binds for the fake driver.
 *
 * Models\SubscriptionItem is abstract — deliberately, so each driver names its own — which
 ...
 */
class FakeSubscriptionItem extends BaseSubscriptionItem {}
