...
use Isapp\CashierSupport\Models\Invoice as BaseInvoice;

/**
 * The concrete Invoice model Cashier::fake() binds for the fake driver.
 *
 * Models\Invoice is abstract — deliberately, so each driver names its own — which
 ...
 */
class FakeInvoice extends BaseInvoice {}
