 ...
 *
 * A concrete package (cashier-revolut, cashier-adyen, ...) binds an
 * implementation of this interface into the container. Concerns resolve it
 * via app(GatewayProvider::class) and delegate every billing operation to it.
 *
